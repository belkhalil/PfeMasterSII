...
App.
	controller('MaClasseController',
			...
			function($scope, $http ,$location, $window, $filter) {
				...
				var mesClasses = 'http://localhost:8080/classes/mesclasses/';
				var getStudents = 'http://localhost:8080/classes/getStudents/';
				var sendMessage = 'http://localhost:8080/classes/messages';
				...
				self.getclasses = function(){
					$http.get(mesClasses).then(
							function(response) {
								self.classes = response.data;
								console.log('Les Classes',self.classes);
